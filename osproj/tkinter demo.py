...
def on_button_click():
    ...
    if wt and tat:
        ...
        # Draw Gantt chart
        draw_gantt_chart(selected_algo, arrival_times, burst_times, wt)

def draw_gantt_chart(selected_algo, arrival_times, burst_times, wt):
    ...
    for i in range(len(arrival_times)):
        x0 = x_start + arrival_times[i] * scaling_factor
        y0 = y_start + i * (bar_height + 10)
...
# Create a button
button = tk.Button(root, text="Get Schedule", command=on_button_click)
